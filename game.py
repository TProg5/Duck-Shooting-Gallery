...
from Classes.GearsClasses.LevelClass import Level

from functions.images_functions.loadimage import load_image


class CreateGame:
    def __init__(self, duck_range: tuple, duck_speed: tuple):
        ...
        self.ammo = Ammo(self.screen, 3, self.bullets)
    ...
    def create_rifle(self):
        Rifle(self.screen, self.images["rifle_image"], (self.WIDTH - 500, self.HEIGHT - 200), self.rifle_sprite)
    ...
    def update_cursor(self):
        if pygame.mouse.get_focused():
            ...
            self.screen.blit(self.images["cursor"], cursor_rect)
